...
export class Class2FAApiRequestFactory extends BaseAPIRequestFactory {
   ...
   */
  public async privacyIdeaAdministrationControllerAssignHardwareToken(
    ...
    if (
      assignHardwareTokenBodyParams === null ||
      assignHardwareTokenBodyParams === undefined
    ) {
   ...
   * @param personId
   */
  public async privacyIdeaAdministrationControllerGetTwoAuthState(
    personId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
    ...
    if (personId !== undefined) {
      requestContext.setQueryParam(
        "personId",
        ObjectSerializer.serialize(personId, "string", ""),
      );
    }
   ...
   */
  public async privacyIdeaAdministrationControllerInitializeSoftwareToken(
   ...
   * @param personId
   */
  public async privacyIdeaAdministrationControllerRequiresTwoFactorAuthentication(
    personId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
   ...
   * @param personId
   */
  public async privacyIdeaAdministrationControllerResetToken(
    personId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
   ...
   */
  public async privacyIdeaAdministrationControllerVerifyToken(
...
export class Class2FAApiResponseProcessor {
   ...
   */
  public async privacyIdeaAdministrationControllerAssignHardwareTokenWithHttpInfo(
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to assign hardware token.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to reset token.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to assign hardware token.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while assigning a hardware token.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async privacyIdeaAdministrationControllerGetTwoAuthStateWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("400", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "A username was not given or not found.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to get token state.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to get token state.",
        undefined,
        response.headers,
      );
    }
    ...
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while retrieving token state.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async privacyIdeaAdministrationControllerInitializeSoftwareTokenWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to create token.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to create token.",
        undefined,
        response.headers,
      );
    }
    ...
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while creating a token.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async privacyIdeaAdministrationControllerRequiresTwoFactorAuthenticationWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to get requirement information.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to get requirement information.",
        undefined,
        response.headers,
      );
    }
    ...
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while getting requirement information.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async privacyIdeaAdministrationControllerResetTokenWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while reseting a token.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async privacyIdeaAdministrationControllerVerifyTokenWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to verify token.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to verify token.",
        undefined,
        response.headers,
      );
    }
    ...
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while verifying a token.",
        undefined,
        response.headers,
      );
    }
