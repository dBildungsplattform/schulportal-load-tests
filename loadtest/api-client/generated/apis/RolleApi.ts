...
export class RolleApiRequestFactory extends BaseAPIRequestFactory {
   ...
   */
  public async rolleControllerAddSystemRecht(
    rolleId: string,
    ...
    if (
      addSystemrechtBodyParams === null ||
      addSystemrechtBodyParams === undefined
    ) {
      throw new RequiredError(
        "RolleApi",
        "rolleControllerAddSystemRecht",
    ...
    // Path Params
    const localVarPath = "/api/rolle/{rolleId}".replace(
      "{" + "rolleId" + "}",
      encodeURIComponent(String(rolleId)),
    );
   ...
   */
  public async rolleControllerCreateRolle(
   ...
   * @param rolleId The id for the rolle.
   */
  public async rolleControllerDeleteRolle(
    rolleId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
   ...
   * @param rolleId The id for the rolle.
   */
  public async rolleControllerFindRolleByIdWithServiceProviders(
    rolleId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
   ...
   */
  public async rolleControllerFindRollen(
    offset?: number,
    limit?: number,
    searchStr?: string,
    _options?: Configuration,
    ...
    if (searchStr !== undefined) {
      requestContext.setQueryParam(
        "searchStr",
        ObjectSerializer.serialize(searchStr, "string", ""),
      );
    }
   ...
   * @param rolleId The id for the rolle.
   */
  public async rolleControllerGetRolleServiceProviderIds(
    rolleId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = "/api/rolle/{rolleId}/serviceProviders".replace(
      "{" + "rolleId" + "}",
      encodeURIComponent(String(rolleId)),
    );
   ...
   */
  public async rolleControllerRemoveServiceProviderById(
    rolleId: string,
    ...
    if (
      rolleServiceProviderBodyParams === null ||
      rolleServiceProviderBodyParams === undefined
    ) {
      throw new RequiredError(
        "RolleApi",
        "rolleControllerRemoveServiceProviderById",
   ...
   */
  public async rolleControllerUpdateRolle(
    rolleId: string,
   ...
   * @param rolleServiceProviderBodyParams
   */
  public async rolleControllerUpdateServiceProvidersById(
    rolleId: string,
    rolleServiceProviderBodyParams: RolleServiceProviderBodyParams,
    _options?: Configuration,
  ): Promise<RequestContext> {
...
export class RolleApiResponseProcessor {
   ...
   */
  public async rolleControllerAddSystemRechtWithHttpInfo(
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to create the rolle.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to create the rolle.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while adding systemrecht to rolle.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async rolleControllerCreateRolleWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("400", response.httpStatusCode)) {
      ...
      throw new ApiException<DbiamRolleError>(
        response.httpStatusCode,
        "The input was not valid.",
        body,
        response.headers,
    ...
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while creating the rolle.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async rolleControllerDeleteRolleWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<void>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to delete the role.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The rolle that should be deleted does not exist.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async rolleControllerFindRolleByIdWithServiceProvidersWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: RolleWithServiceProvidersResponse =
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to get rolle by id.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permission to get rolle by id.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while getting rolle by id.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async rolleControllerFindRollenWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: Array<RolleWithServiceProvidersResponse> =
        ObjectSerializer.deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
    ...
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to get rollen.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while getting all rollen.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async rolleControllerGetRolleServiceProviderIdsWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to retrieve service-providers for rolle.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async rolleControllerRemoveServiceProviderByIdWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<void>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
    ...
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The rolle or the service-provider that should be removed does not exist.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async rolleControllerUpdateRolleWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<RolleWithServiceProvidersResponse>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to update the rolle.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to update the rolle.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while updating the rolle.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async rolleControllerUpdateServiceProvidersByIdWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("400", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The service-provider is already attached to rolle.",
        undefined,
        response.headers,
      );
    }
    ...
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The rolle or the service-provider to add does not exist.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error, the service-provider may could not be found after attaching to rolle.",
        undefined,
        response.headers,
      );
    }
