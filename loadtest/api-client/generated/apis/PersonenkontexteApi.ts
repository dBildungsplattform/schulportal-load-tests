...
export class PersonenkontexteApiRequestFactory extends BaseAPIRequestFactory {
   ...
   */
  public async personenkontextControllerDeletePersonenkontextById(
    ...
    if (
      deleteRevisionBodyParams === null ||
      deleteRevisionBodyParams === undefined
    ) {
      throw new RequiredError(
        "PersonenkontexteApi",
        "personenkontextControllerDeletePersonenkontextById",
    ...
    // Path Params
    const localVarPath = "/api/personenkontexte/{personenkontextId}".replace(
      "{" + "personenkontextId" + "}",
      encodeURIComponent(String(personenkontextId)),
    );
   ...
   * @param personenkontextId The id for the personenkontext.
   */
  public async personenkontextControllerFindPersonenkontextById(
    personenkontextId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
   ...
   * @param systemRecht
   */
  public async personenkontextControllerHatSystemRecht(
    personId: string,
    ...
    // Path Params
    const localVarPath =
      "/api/personenkontexte/{personId}/hatSystemrecht".replace(
        "{" + "personId" + "}",
   ...
   */
  public async personenkontextControllerUpdatePersonenkontextWithId(
    personenkontextId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
...
export class PersonenkontexteApiResponseProcessor {
   ...
   */
  public async personenkontextControllerDeletePersonenkontextByIdWithHttpInfo(
    ...
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The personenkontext was not found.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async personenkontextControllerFindPersonenkontextByIdWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: PersonendatensatzResponseAutomapper =
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async personenkontextControllerFindPersonenkontexteWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: Array<PersonenkontextdatensatzResponse> =
        ObjectSerializer.deserialize(
          ObjectSerializer.parse(await response.body.text(), contentType),
    ...
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The personenkontexte were not found.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async personenkontextControllerHatSystemRechtWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The systemrecht could not be found (does not exist as type of systemrecht).",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async personenkontextControllerUpdatePersonenkontextWithIdWithHttpInfo(
    response: ResponseContext,
