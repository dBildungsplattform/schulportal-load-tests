...
export class OrganisationenApiRequestFactory extends BaseAPIRequestFactory {
   ...
   */
  public async organisationControllerAddAdministrierteOrganisation(
    ...
    if (
      organisationByIdBodyParams === null ||
      organisationByIdBodyParams === undefined
    ) {
      throw new RequiredError(
        "OrganisationenApi",
        "organisationControllerAddAdministrierteOrganisation",
    ...
    // Path Params
    const localVarPath =
      "/api/organisationen/{organisationId}/administriert".replace(
        "{" + "organisationId" + "}",
  ...
  public async organisationControllerAddZugehoerigeOrganisation(
    ...
    // Path Params
    const localVarPath =
      "/api/organisationen/{organisationId}/zugehoerig".replace(
        "{" + "organisationId" + "}",
        encodeURIComponent(String(organisationId)),
      );
   ...
   */
  public async organisationControllerCreateOrganisation(
    ...
    if (
      createOrganisationBodyParams === null ||
      createOrganisationBodyParams === undefined
    ) {
      throw new RequiredError(
        "OrganisationenApi",
   ...
   * @param organisationId The id of an organization
   */
  public async organisationControllerDeleteKlasse(
    organisationId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = "/api/organisationen/{organisationId}/klasse".replace(
      "{" + "organisationId" + "}",
      encodeURIComponent(String(organisationId)),
    );
   ...
   * @param organisationId The id of an organization
   */
  public async organisationControllerEnableForitslearning(
    organisationId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath =
      "/api/organisationen/{organisationId}/enable-for-its-learning".replace(
        "{" + "organisationId" + "}",
        encodeURIComponent(String(organisationId)),
      );
   ...
   * @param organisationId The id of an organization
   */
  public async organisationControllerFindOrganisationById(
    organisationId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
    ...
    // Path Params
    const localVarPath = "/api/organisationen/{organisationId}".replace(
      "{" + "organisationId" + "}",
      encodeURIComponent(String(organisationId)),
    );
  ...
  public async organisationControllerFindOrganizations(
    ...
    if (kennung !== undefined) {
      requestContext.setQueryParam(
        "kennung",
        ObjectSerializer.serialize(kennung, "string", ""),
      );
    }
    ...
    if (searchString !== undefined) {
      requestContext.setQueryParam(
        "searchString",
        ObjectSerializer.serialize(searchString, "string", ""),
      );
    }
   ...
   * @param searchFilter
   */
  public async organisationControllerGetAdministrierteOrganisationen(
    organisationId: string,
    offset?: number,
    limit?: number,
    searchFilter?: string,
    ...
    if (searchFilter !== undefined) {
      requestContext.setQueryParam(
        "searchFilter",
        ObjectSerializer.serialize(searchFilter, "string", ""),
      );
    }
  ...
  public async organisationControllerGetParentsByIds(
    ...
    if (
      parentOrganisationsByIdsBodyParams === null ||
      parentOrganisationsByIdsBodyParams === undefined
    ) {
      throw new RequiredError(
        "OrganisationenApi",
  ...
  /**
   */
  public async organisationControllerGetRootChildren(
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
  ...
  /**
   */
  public async organisationControllerGetRootOrganisation(
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
   ...
   * @param organisationId The id of an organization
   */
  public async organisationControllerGetZugehoerigeOrganisationen(
    organisationId: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;
  ...
  public async organisationControllerUpdateOrganisation(
    ...
    if (
      updateOrganisationBodyParams === null ||
      updateOrganisationBodyParams === undefined
    ) {
      throw new RequiredError(
        "OrganisationenApi",
        "organisationControllerUpdateOrganisation",
   ...
   */
  public async organisationControllerUpdateOrganisationName(
    organisationId: string,
    ...
    if (
      organisationByNameBodyParams === null ||
      organisationByNameBodyParams === undefined
    ) {
      throw new RequiredError(
        "OrganisationenApi",
        "organisationControllerUpdateOrganisationName",
    ...
    // Path Params
    const localVarPath = "/api/organisationen/{organisationId}/name".replace(
      "{" + "organisationId" + "}",
      encodeURIComponent(String(organisationId)),
    );
...
export class OrganisationenApiResponseProcessor {
   ...
   */
  public async organisationControllerAddAdministrierteOrganisationWithHttpInfo(
    ...
    if (isCodeInRange("400", response.httpStatusCode)) {
      ...
      throw new ApiException<DbiamOrganisationError>(
        response.httpStatusCode,
        "The organisation could not be modified.",
        body,
        response.headers,
      );
    }
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to modify the organisation.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not permitted to modify the organisation.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while modifying the organisation.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerAddZugehoerigeOrganisationWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<void>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerCreateOrganisationWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to create the organisation.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not permitted to create the organisation.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while creating the organisation.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerDeleteKlasseWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<void>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to delete the organisation.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The organisation that should be deleted does not exist.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerEnableForitslearningWithHttpInfo(
    response: ResponseContext,
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerFindOrganisationByIdWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<OrganisationResponse>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to get the organization.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to get the organization.",
        undefined,
        response.headers,
      );
    }
    ...
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while getting the organization.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerFindOrganizationsWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to get organizations.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to get organizations.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while getting all organizations.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerGetAdministrierteOrganisationenWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<Array<OrganisationResponse>>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerGetParentsByIdsWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to get the organizations.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to get the organizations.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerGetRootChildrenWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: OrganisationRootChildrenResponse =
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerGetRootOrganisationWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<OrganisationResponse>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
    ...
    if (isCodeInRange("401", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Not authorized to get the root organization.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("403", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Insufficient permissions to get the root organization.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("404", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "The root organization does not exist.",
        undefined,
        response.headers,
      );
    }
    if (isCodeInRange("500", response.httpStatusCode)) {
      throw new ApiException<undefined>(
        response.httpStatusCode,
        "Internal server error while getting the root organization.",
        undefined,
        response.headers,
      );
    }
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerGetZugehoerigeOrganisationenWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<Array<OrganisationResponse>>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerUpdateOrganisationWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<OrganisationResponse>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async organisationControllerUpdateOrganisationNameWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<OrganisationResponseLegacy>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
