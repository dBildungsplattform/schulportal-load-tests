...
export class PersonenFrontendApiResponseProcessor {
     ...
     */
     public async personFrontendControllerFindPersonsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PersonFrontendControllerFindPersons200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: PersonFrontendControllerFindPersons200Response = ObjectSerializer.deserialize(
